...
export default function Loader({message = "Loading...", spinner}){
    return (
        <div className="text-center my-4">
            ...
            {!spinner && <img src={loader_boxes} alt="loader" style={{width:'210px',height:'125px'}}/>}
            {spinner && <img src={loader_spinner} alt="loader" style={{width:'120px',height:'120px'}}/>}
